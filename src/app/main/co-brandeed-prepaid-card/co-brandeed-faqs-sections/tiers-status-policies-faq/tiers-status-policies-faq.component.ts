    ...
    tireStatus: TireStatus[] = [
        {
            ...
            basic: 'FFP Enrolment',
            sapphire: '600 SMILE SMiles',
            platinum: '5,000 SMILES Miles',
        },
        {
            memberShip: 'SMILES Miles Eligibility Period for status upgrades',
            basic: '-',
            sapphire: '6 Months',
            platinum: '1 Years',
        },
        {
            memberShip: 'SMILES Miles Validity for Redeeming Rewards',
            basic: '3 Years',
            sapphire: '3 Years',
            platinum: '3 Years',
        },
        {
            memberShip: 'SMILES Card Validity',
            basic: 'E-Card',
            sapphire: 'Hard Copy Printed Card',
            platinum: '-',
        },
