...
@Component({
    ...
    imports: [AccordionModule, SmilesMembershipFaqComponent, EarningMilesFaqComponent, TiersStatusPoliciesFaqComponent, TiersBenefitsFaqComponent, RewardsFaqComponent, PrivacyFaqComponent],
